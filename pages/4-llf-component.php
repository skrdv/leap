<?php //Template Name: 4. LLF Component with Elements & Strategies Page Template ?>
...
<?php get_template_part('parts/hero','block'); ?>
	
<div class="is-<?php the_field('page_color');  ?>">	
	<?php get_template_part('parts/section','fact'); ?>
</div>	
	...
	<div class="container">
		...
		<?php while (have_rows('section4_elements')): the_row(); ?>	
			...
			<div id="element-<?php echo get_row_index(); ?>" class="collapse row" style="padding: 40px 0;">
					...
					<?php while ( have_rows('strategies-examples') ): the_row(); ?>
						<div class="col-sm-4 readyCard strategy"style="margin-bottom: 32px; " >
							
						<div class="readyCard-inner" style="min-height: 100px;">
							<div class="readyCard-text"><?php the_sub_field('strategie'); ?></div>
							<a href="<?php //the_sub_field('link'); ?>" class="readyCard-button" style="margin-top: 40px;">Show Example</a>
							<div class="readyCard-back">
								<div class="readyCard-text"><?php the_sub_field('example'); ?></div>
								<a href="<?php //the_sub_field('link'); ?>" class="readyCard-button" style="margin-top: 40px;">Show Strategy</a>
							</div>	
						</div>
...
<section class="pageSection pageSection-26">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="pageSection-pre"><?php the_field('section8_title'); ?></div>
				<div><a href="<?php the_field('section8_link'); ?>" class="pageSection-button btn btn-primary"><?php the_field('section8_button'); ?></a></div>
				<div class="pageSection-post"><a href="<?php the_field('section8_link2'); ?>"><?php the_field('section8_text'); ?></a></div>
			</div>
		</div><!-- row -->	
	</div><!-- container -->
</section><!-- pageSection -->	
